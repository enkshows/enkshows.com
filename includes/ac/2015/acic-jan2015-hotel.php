  ...
  <div class="module-content">
    ...
    <div id="concierge-content">
      <div id="concierge-content1" class="showcol-content">
       <h3>Exclusive Hotel Rates</h3><br><br>
        <div class="hotel bg-vendor-hudson">
          <a href="https://www.morganshotelgroup.com/special/hudson-accessories-circuit-intermezzo-collection " class="overlay">
            <span class="attend-show hotel-name">Hudson Hotel</span>
            <span class="attend-date hotel-details">Exclusive Rates for ACIC August 2014</span>
          </a>
        </div>
        <br><br><br> 
        <h3>Other NYC Hotels</h3><br>
        For additional hotel discounts and reservations, please click <a href="http://www2.quikbook.com/event/enkcircuitintermezzo-august14.asp?incentivecode=ENKACIRCUITATT&utm_source=ENKACIRCUIT&utm_medium=site&utm_content=ENKACIRCUITATT&utm_campaign=qbprivatelabelsite">Attendees</a> or <a href="http://www2.quikbook.com/event/enkcircuitintermezzo-august14.asp?incentivecode=ENKACIRCUITEXH&utm_source=ENKACIRCUIT&utm_medium=site&utm_content=ENKACIRCUITEXH&utm_campaign=qbprivatelabelsite">Exhibitors</a>.
      </div>
      <div id="concierge-content2" class="showcol-content">
        ...
        <p>To pre-arrange an account Skyline, please print and complete the <a target="_blank" href="<?php echo PDF_BASE; ?>/skyline_credit_app.pdf">credit application</a>, and mail or fax it to them directly.</p>
      </div>
      ...
      <div id="concierge-content5" class="showcol-content">
        ...
        West 55th Street btwn 9th & 10th Ave, 6am-1am daily, Cash/Credit Card (no trucks or SUV’s)<br><br>
        <strong>GMC PARKING</strong><br>
        West 56th Street btwn 11th and 12th Ave<br>
        <strong>57th STREET GARAGE</strong><br>
        West 57th Street btwn 11th & 12th Ave, 24-hrs, daily, Cash only<br><br>
        <strong>CENTRAL PARKING</strong><br>
        West 57th Street at 11th Ave, 24-hours, daily, Cash and Credit Card<br><br>
        <strong>PARK N RIDE</strong><br>
        West 60th Street btwn 11th & 12th Ave, 24-hours, daily, Cash/Credit Card<br><br>
        <strong>CONCERTO GARAGE</strong><br>
        West 59th Street btwn 10th & 11th Avenues, 24-hours, daily, Cash only<br><br>
      </div>
      <div id="concierge-content6" class="showcol-content">
        ...
        <iframe width="520" height="300" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="<?php echo BASE; ?>/maps/piers.html"></iframe> <br />
      </div>
    </div>
  </div> 
</div> 