...
<div id="footerlinks">
  ...
  <div id="footbox">
    <div id="footboxShows">
      ...
      <a class="show" href="http://www.magiconline.com/project-womens" title="Project Womens">Project Womens</a>
...
<!-- Fixed Footer -->
<div id="footer">
  <div id="lFoot"><a href="http://www.enkshows.com" class="redLink2">ENK INTERNATIONAL</a><span class="foot_space">641 LEXINGTON AVENUE NEW YORK, NY 10022</span><span class="foot_space">T. 212.951.6600</span></div>
  <div id="rFoot"><a href="mailto:enkshows@enkshows.com" class="greyLink" target="_blank">ENKSHOWS@ENKSHOWS.COM</a></div>
    ...
    <!-- // <script src="css/webfonts/ss-social.js"></script> -->
    ...
    <!-- Shadowbox -->  
    <script type="text/javascript" src="js/dev/shadowbox.js"></script>
  ...
  <!-- Testing!  -->
  <!-- Testing!  -->
  <script src="<?php echo BASE;?>/js/dev/jquery.nivo.slider.js"></script>
