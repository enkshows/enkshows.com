...
<div id="form5" class="form5 formhide">
 ...
 <div class="desc-lg">
  ...
  If you have questions during this process, please contact <a href="mailto:info@solecommerce.com">info@solecommerce.com</a> or call 212.951.6600.
</div>
        ...
        <fieldset>
          <div class="formcol-l" >
            <select name="showName" class="showName text-input required" tabindex="501">
              ...
              <option value="SOLE" selected="selected">SOLE COMMERCE</option>
          ...
          <div class="captcha">
            <div class="enkCaptcha" id="scVisitFormCaptcha"></div>
          </div>
        </fieldset>
