<div id="form2" class="form2 formhide">
  ...
  <div class="desc-lg">
    ...
    If you have questions during this process, please contact <a href="mailto:fwd@enkshows.com">fwd@enkshows.com</a> or call 310.857.7500.
  </div>
        ...
        <fieldset>
          <div class="formcol-l" >
            <select name="showName" class="showName text-input required" tabindex="401">
              ...
              <option value="FWD" selected="selected">FWD</option>
          ...
          <div class="captcha">
            <div class="enkCaptcha" id="fwdExhibitorFormCaptcha"></div>
          </div>
        </fieldset>
