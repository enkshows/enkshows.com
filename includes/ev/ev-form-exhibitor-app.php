<div id="form2" class="form2 formhide">
  ...
  <div class="desc-lg">
    ...
    If you have questions during this process, please contact <a href="mailto:enkvegas@enkshows.com">enkvegas@enkshows.com</a> or call 212.951.6600.
  </div>
    ...
    <div id="showApply_form">
      <form id="showApplyForm" method="post" action="../bin/applyForm.php" class="form">
        <fieldset>
          ...
          <div class="captcha">
            <div class="enkCaptcha" id="evExhibitorFormCaptcha"></div>
          </div>
        </fieldset>
