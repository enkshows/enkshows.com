...
$(document).ready(function()
{
    ...
    function ()
    {
        $(this).find('.captionIc, .captionAc').stop(true, true).slideDown("fast");
    },
    function()
    {
        $(this).find('.captionIc, .captionAc').stop(true, true).slideUp("fast");
    });
