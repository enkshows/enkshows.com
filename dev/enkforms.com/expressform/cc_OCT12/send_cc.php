...
$message = $order_type . $message . $spec_req . $e_pack . $add_lights . $add_tracks . $included_furn . $power_package . $dr_tables . $tables_risers . $wall_mounted . $dressing . $ez_shelf . $misc_furn . $autopoles . $carpet . $wallpaperinfo . $companyinfo . $mop . $totalq . $date;
