...
mail("mevans@wsashow.com", $esubject, "$boothsizetopjavits $emessage $ccinfo $checkinfojav", $efrom);
...
mail("mevans@wsashow.com", $bssubject, "$boothsizetop $bsmessage $ccinfo $checkinfobs", $bsfrom);
...
mail("mevans@wsashow.com", $msubject, "$boothsizetop $mmessage $ccinfo $checkinfodnb", $mfrom);
