...
spec_lights1_pr["pre"]=381;
spec_lights1_pr["post"]=381;
...
payinfo = payinfo + "Billing City, State Zip, Country:<input type='text' name='billing_city' size='80' class='address'  style=' border:none; border-bottom:solid windowtext .75pt;'><br /><br />"; 
payinfo = payinfo + "<input type='checkbox' name='ccauth' value='I am authorized to use this credit card'  onclick='sendCCinfo()' align='top'>&emsp;I am authorized to use this credit card."
...
if (ccform.credit.value == '') {alert("Please enter credit card number"); ccform.ccauth.checked = false; return false;}
   else if (ccform.exp_date.value == '') {alert("Please enter expiration date"); ccform.ccauth.checked = false; return false;}
           else if (ccform.cardholder.value == '') {alert("Please enter cardholder"); ccform.ccauth.checked = false; return false;}
                 else if (ccform.ccv.value == '') {alert("Please enter CCV"); ccform.ccauth.checked = false; return false;}
                      else if (ccform.billing_street.value == '') {alert("Please enter street address"); ccform.ccauth.checked = false; return false;}
                           else if (ccform.billing_city.value == '') {alert("Please enter city, state and zip"); ccform.ccauth.checked = false; return false;}
                               
                                     
			                    else {ccform.payauth.value = "okay";
								      return true;}
