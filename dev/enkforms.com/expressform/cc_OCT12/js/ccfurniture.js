...
{	
   ...
   if (totalfurniture > furnallow) {
      alert("Please limit furniture selection to " + furnallow + " items");
	  ccform.chair.value=0;
	  ccform.table4.value=0;
	  ccform.table6.value=0;
	  ccform.rack.value=0;
	  ccform.grid.value=0;
	  ccform.shelfst.value=0;
	  ccform.shelfsl.value=0;
	  var divobj= document.getElementById('totalfurn');
	   divobj.innerHTML= 0;}
   
    else {var divobj= document.getElementById('totalfurn');
