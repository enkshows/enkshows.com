...
$spec_lights4 = $_POST['spec_lights4'];
$spec_lights5 = $_POST['spec_lights5'];
...
$inday2 = $_POST['in_day2'];
$instart2 = $_POST['in_start2'];
$instop2 = $_POST['in_stop2'];
$inworkers2 = $_POST['in_workers2'];

$outday1 = $_POST['out_day1'];
$outstart1 = $_POST['out_start1'];
$outstop1 = $_POST['out_stop1'];
$outworkers1 = $_POST['out_workers1'];
$outday2 = $_POST['out_day2'];
$outstart2 = $_POST['out_start2'];
$outstop2 = $_POST['out_stop2'];
$outworkers2 = $_POST['out_workers2'];
...
$checknumel = $_POST['checknumel'];
$checkamtel = $_POST['checkamtel'];
$checkdateel = $_POST['checkdateel'];
...
if (strlen($elabor) > 2) {$epower = $epower . "
...
$labor = "";
if (strlen($inday1) > 0) {$labor = $labor . $inday1 . "\tStart Time " . $instart1 * 100 . "\t\tStop Time  " . $instop1 * 100 .   "\t# of Workers: " . $inworkers1 . "
";}
if (strlen($inday2) > 0) {$labor = $labor . $inday2 . "\tStart Time " . $instart2 * 100 . "\t\tStop Time  " . $instop2 * 100 .   "\t# of Workers: " . $inworkers2 . "
";}
if (strlen($inday1) > 0 || strlen($inday2)>0) {$labor = "Labor for Installation
" . $labor;}
if (strlen($outday1) > 0 || strlen($outday2)>0) {$labor = $labor . "Labor for Dismantle
";}
if (strlen($outday1) > 0) {$labor = $labor . $outday1 . "\tStart Time " . $outstart1 * 100 . "\t\tStop Time  " . $outstop1 * 100 .   "\t# of Workers: " . $outworkers1 . "
";}
if (strlen($outday2) > 0) {$labor = $labor . $outday2 . "\tStart Time " . $outstart2 * 100 . "\t\tStop Time  " . $outstop2 * 100 .   "\t# of Workers: " . $outworkers2 . "
";}
...
$boothsizetop = "ACIC JANUARY 2013
EXHIBITING COLLECTION NAME:\t$company
BOOTH SIZE:\t\t\t\t$booth_size
";

$boothsizetopges = "ACIC JANUARY 2013
GES Show # 81002639
EXHIBITING COLLECTION NAME:\t$company
BOOTH SIZE:\t\t\t\t$booth_size
";

$boothsizetopelec = "ACIC JANUARY 2013
EXHIBITING COLLECTION NAME:\t$company
BOOTH SIZE:\t\t\t\t$booth_size
";
...
I agree in placing this order that I have accepted the Payment Policy and Contract Terms and Conditions of GES, Port Electrical, BoothSeal and D&B Display Rental as appropriate.
...
$checkinfoel = "";
if (strlen($checknumel) > 0) { $checkinfoel = "
Check # $checknumel
Check Date: $checkdateel
Check Amount \$$checkamtel

Send check to: Port Electrical Services, 711 12th Avenue, Pier 92, NY, NY 10019
include ACIC and your booth #";
...
$message = $order_type . $message . $booth_pack . $spec_req . $tables_risers . $wall_mounted . $dressing .
$ez_shelf . $misc_furn . $autopoles . $carpet . $wallpaper .  $labor . $companyinfo . $mop . $totalq . $date;

$from = "From: ACIC EXPRESS FORM - GES";


mail("mevans@wsashow.com, dcarroll@enkshows.com", $subject,  $message, $from);
mail("enkorders@ges.com", $subject, "$boothsizetopges $message \f $companyinfo $ccinfoges $checkinfoges", $from);
//mail("mevans@enkshows.com,pmonte@ges.com,ssantamaria@enkshows.com, dcarroll@enkshows.com", $subject, "$boothsizetopges $message \f $companyinfo $ccinfoges $checkinfoges", $from);
//mail("mevans@enkshows.com", $subject, "$boothsizetopges $message \f $companyinfo $ccinfoges $checkinfoges", $from);

$message = $order_type .  "
Thank you for your request. This is a summary of what you have requested which has been submitted to GES for the January 2013 ACCESSORIE CIRCUIT. THIS IS NOT A CONFIRMATION. 
...
$emessage = $e_pack . $add_lights . $add_tracks . $spec_lights . $epower ;
...
mail("mevans@wsashow.com, dcarroll@enkshows.com", $esubject, $emessage, $efrom);
mail("enk@portparties.com", $esubject, "$boothsizetopelec $emessage $ccinfo $checkinfoelec", $efrom);
//mail("mevans@wsashow.com,dcarroll@enkshows.com", $esubject, "$boothsizetopelec $emessage $ccinfo $checkinfojj", $efrom);

$emessage = $order_type .  "
Thank you for your request. This is a summary of your electrical request which has been submitted to Port Electrical Services for the January 2013 ACCESSORIE CIRCUIT. THIS IS NOT A CONFIRMATION. 
...
" . $emessage ; 
mail($email, "ACIC Electrical Order", "$emessage $checkinfoel", $efrom); }
...
mail("mevans@wsashow.com, dcarroll@enkshows.com", $bssubject, $bsmessage, $bsfrom);
mail("dtoledo@boothseal.com, joel@cckevents.com", $bssubject, "$boothsizetop $bsmessage $ccinfo $checkinfobs", $bsfrom);
//mail("mevans@wsashow.com,dcarroll@enkshows.com", $bssubject, "$boothsizetop $bsmessage $ccinfo $checkinfobs", $bsfrom);

$bsmessage = $order_type . "
Thank you for your request. This is a summary of your BoothSeal request which has been submitted to BoothSeal LLC for the January 2013 ACCESSORIE CIRCUIT INTERMEZZO CIRCUIT. THIS IS NOT A CONFIRMATION. 
...
mail("mevans@wsashow.com, dcarroll@enkshows.com", $msubject, $mmessage, $mfrom);
mail("orders@dbrentaldisplays.com", $msubject, "$boothsizetop $mmessage $ccinfo $checkinfodnb", $mfrom);
//mail("mevans@wsashow.com,dcarroll@enkshows.com", $msubject, "$boothsizetop $mmessage $ccinfo $checkinfodnb", $mfrom);

$mmessage = $order_type . "
Thank you for your request. This is a summary of your mannequin & hanger request which has been submitted to D&B Rental Displays for the January 2013 ACCESSORIE CIRCUIT INTERMEZZO CIRCUIT. THIS IS NOT A CONFIRMATION. 
...
<table align="center" border=0 cellpadding=0 cellspacing=0 width=1131 style='border-collapse:
 ...
 <tr>
 <td>
 <img src="IMAGES/ACIC_HEADER_JAN13.jpg"  alt="ACIC" width="1150"  align="middle"></p>
 </td>
 </tr>
 <tr>
<td>
