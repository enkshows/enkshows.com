...
$checknumedlen = $_POST['checknumedlen'];
$checkamtedlen = $_POST['checkamtedlen'];
$checkdateedlen = $_POST['checkdateedlen'];
...
$esubject = " $company, Booth # $booth, ENKVEGAS Electrical Order $order_type";
...
$checkinfoedlen = "";
if (strlen($checknumedlen) > 0) { $checkinfoedlen = "
Check # $checknumedlen
Check Date: $checkdateedlen
Check Amount \$$checkamtedlen
";
}
...
$efrom = "From: ENKVEGAS EXPRESS FORM - ELECTRICAL";


if (strlen($emessage) > 0) { 
$emessage = $order_type . $topinfo . $emessage . $companyinfo . $mop .  $etotalq . $edate;


mail("mevans@wsashow.com, smaria@enkshows.com", $esubject, $emessage, $efrom);
mail("lasvegas@edlen.com", $esubject, "$emessage $ccinfo $checkinfoedlen", $efrom);

$emessage = $order_type . "
Thank you for your request. This is a summary of your electrical request which has been submitted to Edlen Electrical Services for the August 2012 ENKVEGAS. THIS IS NOT A CONFIRMATION. 

If you do not receive an order confirmation from EDLEN ELECTRICAL within 4 business days please contact the EDLEN ELECTRICAL SERVICES OFFICE AT 702-770-2737.

Orders received without full payment will not be processed until Edlen Electrical Services receives payment by either check, wire transfer or credit card.  

Reminder:  Do not duplicate your order by either resubmitting the Express Order form or by completing similar forms from the GuideBook.  If you do so, your order will be duplicated and you will be charged twice. 

" . $emessage ; 
mail($email, "ENKVEGAS Electrical Order", $emessage, $efrom); }
