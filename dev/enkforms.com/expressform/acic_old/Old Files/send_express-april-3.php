...
Single 120 watt Gooseneck Floodlight : qty $spec_lights2"; }
if ($spec_lights3 > 0) {$spec_lights = $spec_lights . " 
Single 120 watt Gooseneck Floodlight : qty $spec_lights3"; }
...
500 watts of power : qty $epower2"; }
if ($epower3 > 0) {$epower = $epower . "
500 watts of power : qty $epower3"; }
if ($epower4 > 0) {$epower = $epower . "
500 watts of power : qty $epower4"; }
if ($epower5 > 0) {$epower = $epower . "
500 watts of power : qty $epower5"; }
...
mail("mevans@wsashow.com, mike.wsa@gmail.com, smaria@enkshows", $subject,  $message, $from);

$message = "Thank you for your order. This is a summary of what you have requested which has been submitted to GES for the May 2012 CIRCUIT/INTERMEZZO. THIS IS NOT A CONFIRMATION. 

IF YOU DO NOT RECEIVE AN ORDER CONFIRMATION FROM GES WITHIN 4 BUSINESS DAYS, PLEASE CONTACT THE GES AT 800.801.0554 OR 201.375.9191.

Orders received without full payment will not be processed until GES receives payment by either check, wire transfer or credit card.  If you have not done so already, click here to download the GES credit card authorization form for your convenience.
...
$emessage = $emessage . $companyinfo . $etotal . $edate;
$emessage = "Thank you for your order. This is a summary of your electrical order which has been submitted to Port Electrical Services for the May 2012 CIRCUIT/INTERMEZZO. THIS IS NOT A CONFIRMATION. 

IF YOU DO NOT RECEIVE AN ORDER CONFIRMATION FROM Port Electrical Services WITHIN 4 BUSINESS DAYS, PLEASE CONTACT THE GES AT 800.801.0554 OR 201.375.9191.

Orders received without full payment will not be processed until Port Electrical Services receives payment by either check, wire transfer or credit card.  If you have not done so already, click here to download the Port Electrical Services credit card authorization form for your convenience.

Reminder:  Do not duplicate your order by either resubmitting the Express Order form or by completing similar forms from the GuideBook.  If you do so, your order will be duplicated and your will be charged twice. 

" . $emessage ; mail($email, "Circuit.Intermezzo Order", $emessage, $from); }
...
<b>This is NOT a confirmation of your order.</b><br /><br /></span><span style="font-size: 14.0pt; font-family: Arial, Helvetica, sans-serif;">Thank you for submitting your order to GES. This is your web confirmation only. Please allow 4 business days for orders to be processed. When your order is processed you will receive an order confirmation via email or fax.<br />
&nbsp;<br />
IF YOU DO NOT RECEIVE AN ORDER CONFIRMATION WITHIN 4 BUSINESS DAYS, PLEASE CONTACT THE GES AT 800.801.0554 OR 201.375.9191.
<br /><br />
