...
function calculateTotal()
{
   ...
   //Calculate Electric Subtotal
	...
	if (PackageB > 0 || CPanel > 0) {Paper_lf= eval(P_l_wall) + eval(P_r_wall) + eval(P_b_wall);
	   ...
	   else if (acicform.paperpanel[0].checked || acicform.paperpanel[1].checked) {
	            Paper_lf = eval(l_wall) + eval(r_wall) + eval(b_wall);
				if (acicform.paperpanel[0].checked) {walltype = "wallpaper";}
...
if (pay_type == "check") {
payinfo = payinfo +  "\r\n&emsp;&emsp;&emsp;Check # <input type='text' name='checknumges' size='20' class='xl171'  style=' border:none; border-bottom:solid windowtext .75pt'>\r\n&emsp;&emsp; Check Date: <input type='text' name='checkdateges' size='25' class='xl171'  style=' border:none; border-bottom:solid windowtext .75pt'>\r\n&emsp;&emsp; Check Amount US$ <input type='text' name='checkamtges' size='25' class='xl171'  style=' border:none; border-bottom:solid windowtext .75pt'>\r\n&emsp;&emsp;GES PAYMENT<br />";
payinfo = payinfo +  "\r\n&emsp;&emsp;&emsp;Check # <input type='text' name='checknumjj' size='20' class='xl171'  style=' border:none; border-bottom:solid windowtext .75pt'>\r\n&emsp;&emsp; Check Date: <input type='text' name='checkdatejj' size='25' class='xl171'  style=' border:none; border-bottom:solid windowtext .75pt'>\r\n&emsp;&emsp; Check Amount US$ <input type='text' name='checkamtjj' size='25' class='xl171'  style=' border:none; border-bottom:solid windowtext .75pt'>\r\n&emsp;&emsp;JAVITS PAYMENT<br />";
payinfo = payinfo + "\r\n&emsp;&emsp;&emsp;Check # <input type='text' name='checknumbs' size='20' class='xl171'  style=' border:none; border-bottom:solid windowtext .75pt'>\r\n&emsp;&emsp; Check Date: <input type='text' name='checkdatebs' size='25' class='xl171'  style=' border:none; border-bottom:solid windowtext .75pt'>\r\n&emsp;&emsp; Check Amount US$ <input type='text' name='checkamtbs' size='25' class='xl171'  style=' border:none; border-bottom:solid windowtext .75pt'>\r\n&emsp;&emsp;BOOTHSEAL PAYMENT<br />";
payinfo = payinfo + "\r\n&emsp;&emsp;&emsp;Check # <input type='text' name='checknumdnb' size='20' class='xl171'  style=' border:none; border-bottom:solid windowtext .75pt'>\r\n&emsp;&emsp; Check Date: <input type='text' name='checkdatednb' size='25' class='xl171'  style=' border:none; border-bottom:solid windowtext .75pt'>\r\n&emsp;&emsp; Check Amount US$ <input type='text' name='checkamtdnb' size='25' class='xl171'  style=' border:none; border-bottom:solid windowtext .75pt'>\r\n&emsp;&emsp;D&B RENTAL PAYMENT<br /><br />";
...
payinfo = payinfo + "\r\n&emsp;&emsp;&emsp;BE SURE TO INCLUDE <i>ACIC</i>, YOUR COMPANY NAME AND BOOTH NUMBER (if available)<br /><br />";
}
if (pay_type == "wire") {
