...
{	
   ...
   var swap_one="";
	...
	var fixcount=enknycform.fixcountval.value;
	var fixture=enknycform.fixtureval.value;
	var product=enknycform.prodval.value;
    ...
    if (swapping) {
		...
		swapline1b = " EZ Shelves (dark wood, 70\" w x 72\" h x 11-3/4\" d, 11\" between shelves)";
