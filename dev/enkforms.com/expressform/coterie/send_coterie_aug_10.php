...
<title>COTERIE Booth Furnishings Order</title>
</head>
<body>
...
$attn = $attn ; 
$subject = " $company, Booth # $booth, COTERIE BOOTH Furnishings $order_type"; 
$esubject = " $company, Booth # $booth, COTERIE Electrical Order $order_type";
$bssubject = " $company, Booth # $booth, COTERIE BoothSeal Order $order_type";
$msubject = " $company, Booth # $booth, COTERIE Mannequin Order $order_type";
...
$boothsizetop = "COTERIE SEPTEMBER 2012
EHIBITING COLLECTION NAME:\t$company
BOOTH SIZE:\t\t\t$booth_size
";

$boothsizetopges = "COTERIE SEPTEMBER 2012
GES Show # 018002663
EHIBITING COLLECTION NAME:\t$company
BOOTH SIZE:\t\t\t$booth_size
";
...
$boothsizetopjavits = "COTERIE SEPTEMBER 2012 - Event # 14942
EHIBITING COLLECTION NAME:\t$company
BOOTH SIZE:\t\t\t$booth_size
";
...
$from = "From: COTERIE EXPRESS FORM - GES";
...
mail("enkorders@ges.com, pmonte@ges.com", $subject, "$boothsizetop $message \f $companyinfo $ccinfo $checkinfoges", $from);
...
mail($email, "FASHION COTERIE GES Order", "$message $checkinfoges", $from);

$emessage = $emessage . $spec_lights . $epower ;
$efrom = "From: COTERIE - ELECTRICAL";
...
//mail("mevans@wsashow.com, smaria@enkshows.com", $esubject, "$boothsizetopjavits $emessage $ccinfo $checkinfojj", $efrom);
...
" . $emessage ; 
mail($email, "COTERIE Electrical Order", "$emessage $checkinfojj", $efrom); }

$bsmessage = $boothseal;
$bsfrom = "From: COTERIE - BOOTHSEAL";
...
mail("dmendoza@boothseal.com, dtoledo@boothseal.com, joel@cckevents.com", $bssubject, "$boothsizetop $bsmessage $ccinfo $checkinfobs", $bsfrom);

$bsmessage = $order_type . "
Thank you for your request. This is a summary of your BoothSeal request which has been submitted to BoothSeal LLC for the September 2012 COTERIE/SOLE/TMRW. THIS IS NOT A CONFIRMATION. 
...
mail($email, "FASHION COTERIE BoothSeal", "$bsmessage $checkinfobs", $bsfrom); }


$mmessage = $mmessage . $fmannequin . $mmannequin . $kmannequin . $hangers;
$mfrom = "From: COTERIE - MANNEQUINS/HANGERS";
...
$mmessage = $order_type . "Thank you for your request. This is a summary of your mannequin & hanger request which has been submitted to D&B Rental Displays for the September 2012 COTERIE/SOLE/TMRW. THIS IS NOT A CONFIRMATION. 
...
" . $mmessage ; 
mail($email, "FASHION COTERIE Mannequin/Hanger Order", "$mmessage $checkinfodnb", $mfrom);
...
<table align="center" border=0 cellpadding=0 cellspacing=0 width=1131 style='border-collapse: collapse'>
 <tr>
 <td><img src="IMAGES/FC_HEADER_SEP12.jpg"  alt="COTERIE" width="1130"  align="middle"></td>
 </tr>
 <tr>
 <td>
