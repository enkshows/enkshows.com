...
*/
 ...
 boothseal[7] = "10' x 8' open corner (2 BoothSeal)";
 boothseal[8] = "10' x 10' open corner (2 BoothSeal)";
 boothseal[9] = "10' x 13' open corner (2 BoothSeal)";
 boothseal[10] = "10' x 16' open corner (2 BoothSeal)";
 boothseal[11] = "10' x 20' open corner (3 BoothSeal)";
...
spec_lights1_pr["pre"]=165;
spec_lights1_pr["post"]=196;
...
var deadline="pre";
 ...
 eitem[4]= "add_lights2";
 eitem[5]= "add_lights3";
 eitem[6]= "spec_lights1";
 eitem[7]= "spec_lights2";
 eitem[8]= "spec_lights3";
 eitem[9]= "epower1";
 eitem[10]= "epower2";
 eitem[11]= "epower3";
 eitem[12]= "epower4";
...
function calculateTotal()
{
   ...
   //Calculate Electric Subtotal
	...
	if (PackageB > 0) {Paper_lf= eval(P_l_wall) + eval(P_r_wall) + eval(P_b_wall);
